...
class UploadHandler {
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null, $script_url = null, $upload_dir = null, $data = null) {
        $this->script_url = $script_url;
        $this->upload_dir = $upload_dir;
        $this->data = $data;
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url() . '/' . $this->script_url,
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/' . $this->upload_dir,
            'upload_url' => $this->get_full_url() . '/' . $this->upload_dir,
    ...
    public function post($print_response = true) {
        ...
        if ($this->data['scenario'] == 'original') {
            ...
            foreach ($files as $file) {
                ...
                $filename = $this->upload_dir.$file->name;
                $file_string = sha1_file($filename);
                $model->binary_data = $file_string;
                // end of getting the binary data of the file
