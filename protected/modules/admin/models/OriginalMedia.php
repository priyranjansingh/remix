 ...
 */
class OriginalMedia extends AdminBaseModel
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id, file_name, file_type, file_size, type, binary_data, created_by, modified_by, date_entered, date_modified', 'required'),
			...
			array('id, song_name, artist_name, album_art, slug, initial_key, bpm, file_name, file_type, file_size, type, genre, sub_genre, version, binary_data, status, deleted, created_by, modified_by, date_entered, date_modified', 'safe', 'on'=>'search'),
		);
	}
