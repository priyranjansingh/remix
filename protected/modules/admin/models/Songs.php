...
class Songs extends AdminBaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('s3_url,album_art', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, song_name,album_art, artist_name, slug, s3_bucket, file_name, type, bpm, song_key, genre, sub_genre, sub_sub_genre, s3_url, status, deleted, created_by, modified_by, date_entered, date_modified', 'safe', 'on'=>'search'),
		);
	}
