            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        ...
                        <small>
                            <a href="<?php echo base_url() . '/admin/frontusers/update?id=' . $model->id; ?>">EDIT</a>
                        </small>
                    </h3>
                </div>
                <div class="box-body">
                        ...
                        $this->widget('zii.widgets.CDetailView', array(
                            ...
                            'attributes' => array(
								...
								array( 
									'label'=>'Profile Pic',
									'type'=>'raw',
									'value'=>html_entity_decode(CHtml::image(base_url()."/assets/user-profile/$model->profile_pic",'alt',array('width'=>170,'height'=>116))),
								),
								'state_id',
								'country_id',
						   ),
