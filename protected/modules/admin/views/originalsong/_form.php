...
<noscript><link rel="stylesheet" href="<?php echo base_url(); ?>/assets/jquery_file_uploader/css/jquery.fileupload-ui-noscript.css"></noscript>
   ...
   <script type="text/javascript" src="<?php echo base_url(); ?>/assets/js/originalsong/originalsong.js"></script>
...
<form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <div class="col-xs-6 remix_genre_container" >
            ...
            <select id="original_genre" class="form-control">
            ...
            <div id="original_genre_err" class="errorMessage" style="display:none">Genre can not be empty .</div>
        </div>
        <div class="col-xs-6 remix_version_container">
            <label for="subgenre" class="required">Subgenre: </label>
            <select id="original_subgenre" class="form-control">
    ...
    <div class="form-group">
        <div class="col-xs-6 remix_version_container">
            ...
            <select id="original_version" class="form-control">
            ...
            <div id="original_version_err" class="errorMessage" style="display:none">Version can not be empty .</div>
        </div>
    </div>     
    ...
    <div class="col-xs-12 row fileupload-buttonbar" id="original_uploader">
        <div class="col-lg-7">
