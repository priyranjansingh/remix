...
class Videos extends AdminBaseModel {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('id, song_name, artist_name, album_art, slug, s3_bucket, file_name, type, bpm, song_key, genre, sub_genre, sub_sub_genre, s3_url, status, deleted, created_by, modified_by, date_entered, date_modified', 'safe', 'on' => 'search'),
        );
    }
